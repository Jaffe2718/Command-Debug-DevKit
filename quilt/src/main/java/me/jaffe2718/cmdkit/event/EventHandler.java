...
public abstract class EventHandler {
    ...
    /**
     * The command {@link CommandSuggestor suggetor}
     */
    public static CommandSuggestor suggestor = null;
    ...
    public static void register() {
        ...
        ClientTickEvents.START.register(EventHandler::getSuggestor);
        ClientTickEvents.END.register(EventHandler::showWarning);
    ...
    /**
     * Gets the {@link CommandSuggestor EventHandler.suggestor} by using a Render-Thread
    ...
    private static void getSuggestor(@NotNull MinecraftClient client) {
        if (client.player != null && !lastInput.isEmpty()) {
            ...
            suggestor = ((ChatScreenMixin)chatScreen).getCommandSuggestor();
            suggestor.refresh();
